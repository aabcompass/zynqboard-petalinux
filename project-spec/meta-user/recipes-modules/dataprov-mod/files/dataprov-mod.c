...
MODULE_DESCRIPTION("dataprov-mod - data provider user access module");

/******************************************************************************
*	Internal definitions
*******************************************************************************/
// This module name
#define DRIVER_NAME	"dataprov-mod"

// Created class name
#define CLASS_NAME	"dataprov-cls"

// Created character device name
#define	CDEV_NAME	"dataprov-dev"
...
static struct of_device_id plat_of_match[] = {
	{ .compatible = "xlnx,axi-data-provider-z3-1.0", },
	{ /* end of list */ },
};
